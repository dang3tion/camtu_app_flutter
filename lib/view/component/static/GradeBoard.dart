...
class GradeBoard extends StatefulWidget {
  ...
  const GradeBoard(this.roomId);

  @override
  _GradeBoardState createState() => _GradeBoardState(this.roomId);
}
                ...
                children: [
                  ...
                  StreamBuilder<List<Stream>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Text('Số thành viên hoàn thành bài tập: ${snapshot.data.length}',
                            style: TextStyle(
                              fontSize: 16,
                              color: Colors.grey[600],
                            ));
