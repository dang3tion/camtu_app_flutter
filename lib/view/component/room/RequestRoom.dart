...
class RequestRoomComponent extends StatefulWidget {
  ...
  @override
  _RequestRoomComponentState createState() => _RequestRoomComponentState(this.idRoom);
}
  ...
  Widget createUser(UserAccount user) {
    return Container(
      ...
      child: GestureDetector(
        onTap: (){
          Navigator.push(context, MaterialPageRoute(builder: (context)=>PersonalDetail(user)));
        },
        child: Card(
          child: ListTile(
              ...
              children: [
                RaisedButton(
                  onPressed: () async{
                   ...
                   await RoomServices().acceptUser(user.phoneNo, idRoom, true,'member').then((value) {
                     setState(() {
                       this.loading=false;
                     });
                   });
                ...
                RaisedButton(
                  ...
                  await  RoomServices().acceptUser(user.phoneNo, idRoom, false,'member').then((value){
                    setState(() {
                      this.loading=false;
                    });
                  });
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                loading?LoadingWidget(): StreamBuilder<List<Stream<UserAccount>>>(
